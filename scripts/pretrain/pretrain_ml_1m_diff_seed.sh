...
--weight_decay $weight_decay --fair_reg $fair_reg --seed $seed --data_path ./datasets/${task_type}/ --saving_path ${main_folder}learning_rate_${learning_rate}_weight_decay_${weight_decay}_fair_reg_${fair_reg}_seed_${seed}/ \
