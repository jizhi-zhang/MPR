...
main_folder=./MPR_${task_type}_EXP_seed${seed}_rmse_thresh_eval_batch_random_init_safe_correct/change_ratio_and_epoch/partial_ratio_male${partial_ratio_male}/partial_ratio_female_${partial_ratio_female}/gender_train_epoch_${gender_train_epoch}/
